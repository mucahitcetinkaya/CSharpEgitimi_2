namespace Bolum_13_OOP_Siniflar
{
    internal class Program
    {
        ...
        #region VİDEO 125 Sınıflarda Metotların Kullanımı
        ...
        //    Bölüm 13 OOP Sınıflar VİDEO 125 Sınıflarda Metotların Kullanımı
        ...
        //    Musteri125 e gidelim bir metot olusturalım

        //    1. not baslangıc
        //    1. not bitişi Musteri125 den geldik
        ...
        //    parametre istiyor istediği parametre Musteri125 ün içindeki alanlardan
